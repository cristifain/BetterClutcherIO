...
<html lang="en-US">
  <head>
	...
	<title>Opt-Out Mechanism - The NAI: Network Advertising Initiative</title>
	<link rel="canonical" href="https://thenai.org/glossary/opt-out-mechanism/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Opt-Out Mechanism - The NAI: Network Advertising Initiative" />
	<meta property="og:description" content="An Opt-Out Mechanism is an easy-to-use mechanism by which users may exercise choice to disallow Tailored Advertising with respect to a particular identifier, browser, or device." />
	<meta property="og:url" content="https://thenai.org/glossary/opt-out-mechanism/" />
	<meta property="og:site_name" content="The NAI: Network Advertising Initiative" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https:\/\/schema.org","@graph":[{"@type":"WebPage","@id":"https:\/\/thenai.org\/glossary\/opt-out-mechanism\/","url":"https:\/\/thenai.org\/glossary\/opt-out-mechanism\/","name":"Opt-Out Mechanism - The NAI: Network Advertising Initiative","isPartOf":{"@id":"https:\/\/thenai.org\/#website"},"datePublished":"2021-07-23T20:15:57+00:00","breadcrumb":{"@id":"https:\/\/thenai.org\/glossary\/opt-out-mechanism\/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/thenai.org\/glossary\/opt-out-mechanism\/"]}]},{"@type":"BreadcrumbList","@id":"https:\/\/thenai.org\/glossary\/opt-out-mechanism\/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https:\/\/thenai.org\/"},{"@type":"ListItem","position":2,"name":"Opt-Out Mechanism"}]},{"@type":"WebSite","@id":"https:\/\/thenai.org\/#website","url":"https:\/\/thenai.org\/","name":"The NAI: Network Advertising Initiative","description":"Welcome to the NAI","potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https:\/\/thenai.org\/search\/{search_term_string}"},"query-input":{"@type":"PropertyValueSpecification","valueRequired":true,"valueName":"search_term_string"}}],"inLanguage":"en-US"}]}</script>
	<!-- / Yoast SEO plugin. -->
...
<script>
  ...
  <body class="wp-singular glossary-template-default single single-glossary postid-772 wp-embed-responsive wp-theme-nai opt-out-mechanism">
    ...
    <div class="py-2.5 container-w">
      <div class="flex items-center justify-end space-x-8 xl:space-x-12">
          ...
          class="text-xs text-white xl:text-sm hover:opacity-75">How to Opt Out</a>
                                <a href="https://thenai.org/about-online-advertising/" target=""
          class="text-xs text-white xl:text-sm hover:opacity-75">Understanding Digital Advertising</a>
                                <a href="https://thenai.org/consumer-input-feedback/" target=""
          class="text-xs text-white xl:text-sm hover:opacity-75">Consumer Input &amp; Feedback</a>
  ...
  <div class="bg-white shadow">
        ...
        <div class="hidden lg:flex">
            ...
            <div class="flex items-center group">
              <a id="primary-1"
                ...
                href="https://thenai.org/about-the-nai-2/" target="" data-int="1">
            ...
            <div class="flex items-center group">
              <a id="primary-2"
                class="pl-4 xl:pl-10 primary-link inline-flex items-center py-7 nav-link tracking-wider transition duration-300 ease-in-out focus:outline-none text-[0.8rem] hover:text-c-blue-300 xl:text-base xl:py-8  "
                href="https://thenai.org/self-regulatory-framework/" target="" data-int="2">
            ...
            <div class="flex items-center group">
              <a id="primary-3"
                class="pl-4 xl:pl-10 primary-link inline-flex items-center py-7 nav-link tracking-wider transition duration-300 ease-in-out focus:outline-none text-[0.8rem] hover:text-c-blue-300 xl:text-base xl:py-8  "
                href="https://thenai.org/policy-news/" target="" data-int="3">
            ...
            <div class="flex items-center group">
              <a id="primary-4"
                class="pl-4 xl:pl-10 primary-link inline-flex items-center py-7 nav-link tracking-wider transition duration-300 ease-in-out focus:outline-none text-[0.8rem] hover:text-c-blue-300 xl:text-base xl:py-8  "
                href="https://thenai.org/how-to-join/" target="" data-int="4">
        ...
        <div class="grid grid-cols-2 gap-12 py-8 divide-x-2 divide-gray-300 xl:gap-16">
          ...
          <div class="flex items-center">
            <div class="flex flex-col w-full ml-12 space-y-4 xl:ml-16">
                            <a href="https://thenai.org/about-the-nai-2/" class="flex items-center justify-between py-2 border-b-gradient-2 group">
                <span
                  class="text-2xl font-bold transition duration-200 transform xl:text-lg group-hover:scale-110 group-hover:text-c-blue-300">About the NAI</span>
                ...
                <span
                  class="text-2xl font-bold transition duration-200 transform xl:text-lg group-hover:scale-110 group-hover:text-c-blue-300">Staff &amp; Board</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transform -rotate-45 group-hover:text-c-blue-200"
                  viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
                ...
                <span
                  class="text-2xl font-bold transition duration-200 transform xl:text-lg group-hover:scale-110 group-hover:text-c-blue-300">NAI Members</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transform -rotate-45 group-hover:text-c-blue-200"
                  viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transform -rotate-45 group-hover:text-c-blue-200"
                  ...
                  <path fill-rule="evenodd"
                    ...
                    clip-rule="evenodd" />
                            ...
                            <a href="https://thenai.org/how-to-join/member-resources/" class="flex items-center justify-between py-2 border-b-gradient-2 group">
                <span
                  class="text-2xl font-bold transition duration-200 transform xl:text-lg group-hover:scale-110 group-hover:text-c-blue-300">Members Resources</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transform -rotate-45 group-hover:text-c-blue-200"
                  viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
    ...
    <div class="w-full bg-white ">
      <div class=" container-w">
        <div class="grid grid-cols-2 gap-12 py-8 divide-x-2 divide-gray-300 xl:gap-16">
          ...
          <div class="flex items-center">
            <div class="flex flex-col w-full ml-12 space-y-4 xl:ml-16">
                            <a href="https://thenai.org/annual-report-2025/" class="flex items-center justify-between py-2 border-b-gradient-2 group">
                <span
                  class="text-2xl font-bold transition duration-200 transform xl:text-lg group-hover:scale-110 group-hover:text-c-blue-300">Annual Report 2025</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transform -rotate-45 group-hover:text-c-blue-200"
                  viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
    ...
    <div class="w-full bg-white ">
      <div class=" container-w">
        <div class="grid grid-cols-2 gap-12 py-8 divide-x-2 divide-gray-300 xl:gap-16">
          <div clss="flex items-center">
            <a href="https://thenai.org/how-to-join/" class="flex items-center w-full h-full group">
              <div class="relative bg-gray-100 h-[16rem] xl:h-[17rem] overflow-hidden">
                                <img src="/wp-content/uploads/2026/07/NAI-Banners_How-to-join_NAI-scaled.png" alt=""
                  class="object-cover object-center w-full min-h-[16rem] xl:min-h-[17rem] group-hover:scale-110 transform transition duration-300">
                                <div
                  class="absolute top-0 left-0 px-20 py-12 text-3xl font-bold xl:text-4xl group-hover:text-c-blue-300">
                  How to Join</div>
          ...
          <div class="flex items-center">
            <div class="flex flex-col w-full ml-12 space-y-4 xl:ml-16">
                            <a href="https://thenai.org/how-to-join/membership-benefits-3/" class="flex items-center justify-between py-2 border-b-gradient-2 group">
                <span
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transform -rotate-45 group-hover:text-c-blue-200"
                  ...
                  <path fill-rule="evenodd"
                    ...
                    clip-rule="evenodd" />
                            ...
                            <a href="https://thenai.org/how-to-join/join-the-nai/" class="flex items-center justify-between py-2 border-b-gradient-2 group">
                <span
  ...
  <div x-show="open" class="relative border-t border-gray-200 bg-gray-50 z-60 lg:hidden" x-cloak>
        ...
        <div class="inline-flex flex-col font-gt">
            ...
            <div :class="{'block': open, 'hidden': !open }" class="w-full" x-cloak>
              <ul class="inline-flex flex-col py-2 pl-4 space-y-3">
                  ...
                  href="https://thenai.org/about-the-nai-2/">About the NAI</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/about-the-nai-2/staff/">Staff &amp; Board</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/about-the-nai-2/members/">NAI Members</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  ...
                  href="https://thenai.org/about-the-nai-2/nai-working-groups/working-group-participants/">Working Group Participants</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/how-to-join/member-resources/">Members Resources</a>
                              </ul>
            </div>
          </div>
                    <div x-data="{ open: false }">
            ...
            <div :class="{'block': open, 'hidden': !open }" class="w-full" x-cloak>
              <ul class="inline-flex flex-col py-2 pl-4 space-y-3">
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/annual-report-2025/">Annual Report 2025</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
            ...
            <div class="flex items-center">
              <a @click="open = false"
                class="inline-block py-2 nav-link md:pb-1 tracking-wider transition duration-300 ease-in-out focus:outline-none md:text-base hover:text-c-blue-300 border-b-gradient sm:py-3  "
                href="https://thenai.org/how-to-join/" target="">
                How to Join
              </a>
                            <button class="focus:outline-none" @click="open = !open">
                <svg xmlns=" http://www.w3.org/2000/svg" class="w-6 h-6 ml-2.5 transform text-c-blue-200"
            ...
            <div :class="{'block': open, 'hidden': !open }" class="w-full" x-cloak>
              <ul class="inline-flex flex-col py-2 pl-4 space-y-3">
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/how-to-join/membership-benefits-3/">NAI Membership Benefits</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/how-to-join/join-the-nai/">Join the NAI</a>
                                <a class="transition duration-300 hover:text-c-blue-300 border-b-gradient"
                  href="https://thenai.org/how-to-join/member-resources/">Members Resources</a>
                              </ul>
            </div>
            ...
            <a href="https://thenai.org/how-to-opt-out/" target="" @click="open = false"
              class="inline-block py-2 nav-link md:pb-1 tracking-wider transition duration-300 ease-in-out focus:outline-none md:text-base hover:text-c-blue-300 border-b-gradient sm:py-3  ">How to Opt Out</a>
                    ...
                    <div class="sm:hidden">
            <a href="https://thenai.org/about-online-advertising/" target="" @click="open = false"
              class="inline-block py-2 nav-link md:pb-1 tracking-wider transition duration-300 ease-in-out focus:outline-none md:text-base hover:text-c-blue-300 border-b-gradient sm:py-3  ">Understanding Digital Advertising</a>
          </div>
                    <div class="sm:hidden">
            <a href="https://thenai.org/consumer-input-feedback/" target="" @click="open = false"
              class="inline-block py-2 nav-link md:pb-1 tracking-wider transition duration-300 ease-in-out focus:outline-none md:text-base hover:text-c-blue-300 border-b-gradient sm:py-3  ">Consumer Input &amp; Feedback</a>
          </div>
                    <div class="sm:hidden">
    ...
    <main id="main" class="">
             <article class="relative post-772 glossary type-glossary status-publish hentry">
    ...
    <div class="lg:flex lg:space-x-12 xl:space-x-24">
      <div class="min-w-[250px] pb-12">
        <div class="mb-8 text-xl font-bold normal-case font-gt md:text-2xl xl:text-3xl sm:mb-12 lg:mb-20">
                    <div class="underline">July 23, 2021</div>
        </div>
...
<p class="wp-block-paragraph">An Opt-Out Mechanism is an easy-to-use mechanism by which users may exercise choice to disallow Tailored Advertising with respect to a particular identifier, browser, or device.</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- <div class="bg-[#F5F5F5]">
  <div class="py-12 container-w lg:py-16">
    ...
    <div class="grid grid-cols-1 gap-6 pb-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 xl:gap-12 2xl:gap-16 similar-posts">
                   <article class="policy-shadow flex flex-col single-blog post-772 glossary type-glossary status-publish hentry">
  ...
  <div class="flex flex-col justify-between flex-grow p-4 lg:p-6 content-container">
    <div>
      ...
      <div class="entry-summary line-clamp-3 text-[#666666] mb-2 lg:mb-3">
        Two years have passed since the NAI published the&nbsp;2020 Code of Conduct (Code), expanding the scope of the NAI self-regulatory program to the use of offline data for Tailored Advertising, and announcing the development of the industry’s first email-based consumer choice mechanism for Tailored Advertising. The NAI’s email-based consumer choice mechanism is now live on      </div>
    </div>
...
</article>                   <article class="policy-shadow flex flex-col single-blog post-772 glossary type-glossary status-publish hentry">
  <div class="w-full h-48 border-b border-gray-100 xl:h-56">
  ...
  <div class="flex flex-col justify-between flex-grow p-4 lg:p-6 content-container">
    <div>
      ...
      <div class="entry-summary line-clamp-3 text-[#666666] mb-2 lg:mb-3">
        A national trade group representing the digital advertising industry has advised member companies to put stricter controls on consumer mobile-phone location data they provide to government units such as public health authorities and law-enforcement and intelligence agencies.      </div>
    </div>
  ...
  <path fill="#fff" fill-rule="nonzero" d="M403.229 0h78.506L310.219 196.04 512 462.799H354.002L230.261 301.007 88.669 462.799h-78.56l183.455-209.683L0 0h161.999l111.856 147.88L403.229 0zm-27.556 415.805h43.505L138.363 44.527h-46.68l283.99 371.278z"></path>
      ...
      <div class="mt-12 sm:flex sm:items-center sm:justify-between sm:mt-24 xl:grid xl:grid-cols-3 xl:mt-36">
        ...
        <p id="footer-copyright" class="mt-12 text-sm text-white sm:mt-0 sm:order-1 xl:col-start-2 xl:text-center">
          &copy; 2026 The NAI: Network Advertising Initiative. All rights reserved.
        </p>
      </div>
    </div>
  </div>
